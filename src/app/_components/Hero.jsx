...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen bg-cover bg-center bg-fixed bg-blend-multiply flex items-center justify-center text-white text-center px-6 md:px-12 bg-[url('/images/image_8.jpg')]" style={styles}>
      <div className="absolute"></div>
      <div className="relative max-w-2xl">
        <h1 className="text-4xl md:text-6xl font-bold">Your Favourite Food Served Hot and Fresh!</h1>
